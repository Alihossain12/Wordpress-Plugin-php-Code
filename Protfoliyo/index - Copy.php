...
<html lang="en">
  ...
  <body>
    ...
    <!-- Floating Navigation -->
      ...
      <div class="floating-nav-item" data-target="about">
        <span class="floating-nav-tooltip">About</span>
      </div>
      <div class="floating-nav-item" data-target="experience">
        <span class="floating-nav-tooltip">Experience</span>
      </div>
      <div class="floating-nav-item" data-target="skills">
        <span class="floating-nav-tooltip">Skills</span>
      </div>
      <div class="floating-nav-item" data-target="services">
        <span class="floating-nav-tooltip">Services</span>
      </div>
      ...
      <div class="container">
        <div class="hero-content">
          <div class="hero-text animate-fade-in">
            <h1 class="hero-title">MD:ALI HOSSAIN</h1>
            ...
            <div class="social-links">
              <a
                href="https://github.com/Alihossain12"
                class="social-link"
              ...
              <a
                href="mailto:mdalihossain32246886@gmail.com"
                class="social-link"
          ...
          <div class="hero-image animate-fade-in delay-2">
            <div class="hero-image-container">
              ...
              <div class="hero-image-bg2"></div>
              <div class="hero-image-frame">
                <img src="1725095383847.jpg" alt="Ali hossain" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="about-content">
          <div class="about-text animate-fade-in">
            <p class="about-description">
              As a passionate Web Developer, I specialize in building robust and
              scalable web applications. With a strong foundation in MongoDB,
              Express.js, React, and Node.js, I create seamless full-stack
          ...
          <div class="skills-grid">
            <div class="card skill-card animate-fade-in delay-1">
              ...
              <h3>Frontend</h3>
              <p>React, Next.js, Redux</p>
            </div>
            <div class="card skill-card animate-fade-in delay-2">
              <div class="skill-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              <h3>Backend</h3>
              <p>Node.js, Express, Fastify</p>
            </div>
            <div class="card skill-card animate-fade-in delay-3">
              <div class="skill-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
            ...
            <div class="card skill-card animate-fade-in delay-4">
              <div class="skill-icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
     ...
     <?php include_once 'Home-page-php/Experience.php';?>
      ...
      <div class="container">
        ...
        <div class="experience-list">
          <div class="card experience-card animate-fade-in">
            ...
            <ul class="experience-responsibilities">
              ...
              <li>Creating RESTful APIs and managing MongoDB databases</li>
              <li>
                Collaborating with clients to deliver high-quality solutions
              </li>
            </ul>
          </div>
          <div class="card experience-card animate-fade-in delay-1">
            <div class="experience-header">
              <h3 class="experience-company">Salaba Fasteners</h3>
              <span class="experience-period">2024 - Present</span>
            </div>
            <h4 class="experience-role">Web Developer</h4>
            <div class="experience-location">
            ...
            <ul class="experience-responsibilities">
              <li>Developed full-fledged ERP system using MERN stack</li>
              <li>Designed and implemented RESTful APIs</li>
              <li>Created responsive interfaces with React.js and Redux</li>
              <li>Implemented secure authentication systems</li>
              <li>Utilized WebSockets for real-time features</li>
            </ul>
          </div>
          <div class="card experience-card animate-fade-in delay-2">
            <div class="experience-header">
              <h3 class="experience-company">TechVention</h3>
            ...
            <ul class="experience-responsibilities">
              <li>Migrated codebase to Fastify with TypeScript</li>
              <li>Implemented OOP concepts for scalability</li>
              <li>Built backend REST API and OAuth</li>
              <li>Integrated third-party APIs</li>
              <li>Implemented i18n features</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <!-- Skills Section -->
     <?php include_once 'Home-page-php/Skills.php';?>
      ...
      <div class="container">
        ...
        <div class="skills-grid">
          <div class="card skill-card animate-fade-in">
            <div class="skill-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <p>
              ...
              React features and Next.js for optimal performance.
            </p>
          </div>
          <div class="card skill-card animate-fade-in delay-1">
            <div class="skill-icon">
            ...
            <p>Node.js, Express, Fastify</p>
            <p>
              Creating robust server-side applications with focus on scalability
          ...
          <div class="card skill-card animate-fade-in delay-3">
            ...
            <p>
              Crafting beautiful and intuitive user interfaces with modern
      ...
      <div class="container">
        ...
        <div class="skills-grid">
          <div class="card skill-card animate-fade-in">
            ...
            <p>
              Custom web applications built with React and Next.js, focusing on
          ...
          <div class="card skill-card animate-fade-in delay-2">
            ...
            <p>
              RESTful and GraphQL API design and implementation for seamless
          ...
          <div class="card skill-card animate-fade-in delay-3">
            ...
            <p>
              Mobile-first, responsive web designs that work flawlessly across
