<div class="container mt-5">
    ...
    <form method="POST" enctype="multipart/form-data" action="add.php" class="border p-4 rounded bg-light">
        ...
        <input class="form-control mb-2" type="file" name="images" placeholder="Images">
